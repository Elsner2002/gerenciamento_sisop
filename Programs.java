...
class Programs {
	...
	private static Word[] fatorial = new Word[] {
	...
	private static Word[] progMinimo = new Word[] {
	...
	private static Word[] fibonacci10 = new Word[] { // mesmo que prog exemplo, so que usa r0 no lugar de r8
	...
	private static Word[] fatorialTRAP = new Word[] {
	...
	private static Word[] fibonacciTRAP = new Word[] { // mesmo que prog exemplo, so que usa r0 no lugar de r8
	...
	private static Word[] PB = new Word[] {
