...
class Programs {
	...
	public static String getName(Word[] words){
		...
		static Word[] progMinimo = new Word[] {
		...
		static Word[] fibonacci10 = new Word[] { // mesmo que prog exemplo, so que usa r0 no lugar de r8
		...
		static Word[] fatorialTRAP = new Word[] {
		...
		static Word[] PC = new Word[] {
				...
				new Word(Opcode.JMPIEM, -1, 6, 55), // CHAVE 3 para pular quando r7 for 1 e r6 0 para interomper o loop
													// de vez do programa
				...
				new Word(Opcode.DATA, -1, -1, -1),
				new Word(Opcode.DATA, -1, -1, -1),
				new Word(Opcode.DATA, -1, -1, -1), // POS 53
				new Word(Opcode.DATA, -1, -1, -1),
				new Word(Opcode.DATA, -1, -1, -1),
				new Word(Opcode.DATA, -1, -1, -1),
				new Word(Opcode.DATA, -1, -1, -1) };
